...
!(function () {
  ...
  ;-1 < navigator.platform.indexOf("Win") &&
    ...
    document.getElementsByClassName("navbar-collapse")[0] &&
      ((t = document.querySelector(".navbar-collapse")), new PerfectScrollbar(t)),
...
function sidebarColor(e) {
  for (var t = e.parentElement.children, n = e.getAttribute("data-color"), i = 0; i < t.length; i++)
...
function sidebarType(e) {
  for (var t = e.parentElement.children, n = e.getAttribute("data-class"), i = 0; i < t.length; i++)
    t[i].classList.remove("active")
  e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active")
      ...
      if (s) {
        ...
        if (n.classList.contains("flex-column")) {
          ...
          ;(i.style.transform = "translate3d(0px," + t + "px, 0px)"),
            (i.style.width = n.querySelector("li:nth-child(" + a + ")").offsetWidth + "px"),
            (i.style.height = n.querySelector("li:nth-child(" + l + ")").offsetHeight)
        } else {
